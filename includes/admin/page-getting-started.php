...
<div class="wrap lflow-wrap">
    ...
    <div class="lflow-card">
        ...
        <p style="margin-top:0; font-size:.875rem; color:#3c434a;">
            ...
            <?php esc_html_e( '• 🌙 Audit automatique : Un worker en arrière-plan (cron) s\'exécute toutes les 8 heures (à 06h00, 14h00 et 22h00) pour scanner toutes les licences disponibles en stock. Si des clés bloquées ou MAK épuisées sont détectées, elles sont désactivées, le stock WooCommerce est mis à jour en temps réel et un rapport d\'alerte vous est envoyé par e-mail.', 'licenceflow' ); ?>
        </p>
